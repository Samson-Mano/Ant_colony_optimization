Public Class Form1
    ...
    Private Sub Button_Simulate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Simulate.Click
        ...
        For lv1 = 0 To (NC - 1) Step 1
            '----- range of 25 to 325
            TempN = New Cities(Rnd1.Next(-(Panel_PathPic.Width - 5) * 0.5, (Panel_PathPic.Width - 5) * 0.5), Rnd1.Next(-(Panel_PathPic.Height - 5) * 0.5, (Panel_PathPic.Height - 5) * 0.5))
            Nodes.Add(TempN)
        Next
    ...
    Private Sub Panel_PathPic_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Panel_PathPic.Paint
        ...
        e.Graphics.TranslateTransform(Panel_PathPic.Width * 0.5F, Panel_PathPic.Height * 0.5F)
